...
if (isset($title)) {
    ...
    <input type="text" name="new_title" value="<?php echo $title; ?>" readonly required>
    <br>
    <label for="new_img">Nouvelle image :</label>
<input type="text" name="new_img" value="<?php echo $img; ?>" readonly required>

    <label for="new_description">Nouvelle description :</label>
    <textarea name="new_description" required readonly><?php echo $description; ?></textarea>
    <br>
